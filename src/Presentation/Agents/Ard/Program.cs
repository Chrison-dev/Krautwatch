...
// Krautwatch Ard agent (DR-009). A microservice host wired to Postgres + durable Wolverine;
...
// TODO (#3): register the ARD (+ KiKA) crawl Action and schedule it (Application/Crawling/Ard).
